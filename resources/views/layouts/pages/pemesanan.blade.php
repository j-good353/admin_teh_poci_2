...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <!-- ============================================================== -->
            <title>Admin - Pemesanan Teh Poci</title>
            <style>
              body {
          ...
          <body>
            <header>
              <h1>Pemesanan Teh Poci - Admin</h1>
            </header>
            ...
            <section>
              <form>
                ...
                <button type="submit" class="add-product-btn">Tambah Produk</button>
              </form>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>1</td>
                    <td><img src="path/to/product/image.jpg" alt="Product Image" width="50"></td>
